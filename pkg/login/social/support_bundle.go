...
func (ss *SocialService) supportBundleCollectorFn(name string, sc connector.SocialConnector, oinfo *models.OAuthInfo) func(context.Context) (*supportbundles.SupportItem, error) {
