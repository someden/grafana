...
import (
	...
	models "github.com/grafana/grafana/pkg/login/social/models"
...
func (_m *MockSocialConnector) GetOAuthInfo() *models.OAuthInfo {
	ret := _m.Called()

	var r0 *models.OAuthInfo
	if rf, ok := ret.Get(0).(func() *models.OAuthInfo); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.OAuthInfo)
		}
	}
...
func (_m *MockSocialConnector) UserInfo(ctx context.Context, client *http.Client, token *oauth2.Token) (*models.BasicUserInfo, error) {
	ret := _m.Called(ctx, client, token)

	var r0 *models.BasicUserInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *http.Client, *oauth2.Token) (*models.BasicUserInfo, error)); ok {
		return rf(ctx, client, token)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *http.Client, *oauth2.Token) *models.BasicUserInfo); ok {
		r0 = rf(ctx, client, token)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.BasicUserInfo)
		}
	}
